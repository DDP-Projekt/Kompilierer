...
func (c *Compiler) defineStringType() *ddpIrStringType {
	...
	ddpstring.fromConstantsIrFun = c.declareExternalRuntimeFunction("_ddp_string_from_constant", void, ir.NewParam("ret", ddpstring.ptr), ir.NewParam("str", ptr(i8)))

	// frees the given string
	ddpstring.freeIrFun = c.declareExternalRuntimeFunction("_ddp_free_string", void, ir.NewParam("str", ddpstring.ptr))

	// places a copy of str in ret allocating new buffers
	ddpstring.deepCopyIrFun = c.declareExternalRuntimeFunction("_ddp_deep_copy_string", void, ir.NewParam("ret", ddpstring.ptr), ir.NewParam("str", ddpstring.ptr))
	...
	ddpstring.replaceCharIrFun = c.declareExternalRuntimeFunction("_ddp_replace_char_in_string", void, ir.NewParam("str", ddpstring.ptr), ir.NewParam("ch", ddpchar), ir.NewParam("index", ddpint))

	ddpstring.sliceIrFun = c.declareExternalRuntimeFunction("_ddp_string_slice", void, ir.NewParam("ret", ddpstring.ptr), ir.NewParam("str", ddpstring.ptr), ir.NewParam("index1", ddpint), ir.NewParam("index2", ddpint))

	ddpstring.str_str_concat_IrFunc = c.declareExternalRuntimeFunction("_ddp_string_string_verkettet", void, ir.NewParam("ret", ddpstring.ptr), ir.NewParam("str1", ddpstring.ptr), ir.NewParam("str2", ddpstring.ptr))
	ddpstring.char_str_concat_IrFunc = c.declareExternalRuntimeFunction("_ddp_char_string_verkettet", void, ir.NewParam("ret", ddpstring.ptr), ir.NewParam("c", ddpchar), ir.NewParam("str", ddpstring.ptr))
	ddpstring.str_char_concat_IrFunc = c.declareExternalRuntimeFunction("_ddp_string_char_verkettet", void, ir.NewParam("ret", ddpstring.ptr), ir.NewParam("str", ddpstring.ptr), ir.NewParam("c", ddpchar))

	ddpstring.int_to_string_IrFun = c.declareExternalRuntimeFunction("_ddp_int_to_string", void, ir.NewParam("ret", ddpstring.ptr), ir.NewParam("i", ddpint))
	ddpstring.float_to_string_IrFun = c.declareExternalRuntimeFunction("_ddp_float_to_string", void, ir.NewParam("ret", ddpstring.ptr), ir.NewParam("f", ddpfloat))
	ddpstring.bool_to_string_IrFun = c.declareExternalRuntimeFunction("_ddp_bool_to_string", void, ir.NewParam("ret", ddpstring.ptr), ir.NewParam("b", ddpbool))
	ddpstring.char_to_string_IrFun = c.declareExternalRuntimeFunction("_ddp_char_to_string", void, ir.NewParam("ret", ddpstring.ptr), ir.NewParam("c", ddpchar))
