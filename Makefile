...
EXT_BIN_LIBBACKTRACE = libbacktrace.a
...
external: external-headers
	$(CP) $(EXT_DIR)$(EXT_BIN_PCRE2) $(EXT_DIR)$(EXT_BIN_LIBAR) $(EXT_DIR)$(EXT_BIN_LIBZ) $(EXT_DIR)$(EXT_BIN_LIBLZMA) $(EXT_DIR)$(EXT_BIN_LIBBZ2) $(EXT_DIR)$(EXT_BIN_LIBLZ4) $(EXT_DIR)$(EXT_BIN_LIBBACKTRACE) $(LIB_DIR_OUT)
