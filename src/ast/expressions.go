...
func (expr *CastAssigneable) String() string { return "CastAssigneable" }
...
func (expr *CastAssigneable) Token() token.Token { return expr.Lhs.Token() }
...
func (expr *CastAssigneable) GetRange() token.Range { return expr.Range }
...
func (expr *CastAssigneable) Accept(v FullVisitor) VisitResult { return v.VisitCastAssigneable(expr) }
...
func (expr *CastAssigneable) expressionNode() {}
...
func (expr *CastAssigneable) assigneable() {}
